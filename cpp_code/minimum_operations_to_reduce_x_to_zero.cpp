...
As you count the sum of the first l numbers,
you need to find a complement (x - sum) number formed by numbers on the right.
To do so, we can use a hashmap where we will store the rolling sum.
*/
class Solution {
public:
