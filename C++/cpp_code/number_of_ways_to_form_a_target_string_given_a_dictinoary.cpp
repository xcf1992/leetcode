...
Try each index for source word(s),
then update res[j + 1] from right to left due to causal relationship,
also it corrupts result if updating from left to right
*/
class Solution {
public:
