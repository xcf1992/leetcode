...
roads[i] = [ai, bi, distancei] indicates that there is a bidirectional road between cities ai and bi with a distance
...
the path. The test cases are generated such that there is at least one path between 1 and n.
