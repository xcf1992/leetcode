...
/*
 Suppose there are 10 buckest, 10 minutes to test and the pig dies after 3 minutes. then we can test at most 3 rounds. For each bucket, a big can drink it during round 1 or round 2 or round 3 or not drink at all ( 4 possibilities ). Convert each bucket to a number of base 4.
