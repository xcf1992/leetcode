...
/*
 ...
 first, as dan39 said,only need check N/2. so when N==2000, only need check 1000 nums.
 second, because len(S) <= 1000, so if len(S) == 1000, only can have (1000-9)=991 nums. so N can not bigger than 991 * 2, almost 2000.
