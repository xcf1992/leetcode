/*
 ...
 Given the ball's start bfs, the destination and the maze, find the shortest distance for the ball to stop at the destination.
 The distance is defined by the number of empty spaces traveled by the ball from the start bfs (excluded) to the destination (included).
