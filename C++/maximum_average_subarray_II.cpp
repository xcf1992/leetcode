...
private:
    bool check(vector<int>& nums, double mid, int k) {
        ...
        /*
        * min_sum represent the min prefix sum of the array. When there is no element, the prefix sum is 0.
        ...
        *
        * When we enter this for-loop, we are at least at position k+1.
